export const projects = [
...

  {
    ...
    title: "Koothattukulam Projects",
    description:
      "Modern homes designed with efficient layouts, natural lighting, and a focus on comfortable urban living.",
    images: [
